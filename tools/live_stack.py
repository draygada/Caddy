...
LIVE = {
    ...
    'CADDYDADDY_LIVE_LLM_CALLS_CAP': '5',                    # enough for one bounded USML-to-CCL path
    'CADDYDADDY_LIVE_LLM_COST_CAP_MICROUSD': '1250000',      # 1.25 USD maximum reserved per request
    'CADDYDADDY_LIVE_LLM_ESTIMATED_CALL_COST_MICROUSD': '250000',  # 0.25 USD reserved per call
    'CADDYDADDY_LIVE_LLM_TIMEOUT_SECONDS': '35',                   # below the outer request ceiling
}
