...
_EXAMPLE = {
    ...
    "candidates": [
        ...
        },
        {
            ...
            "status": "knocked_out", "pursuit": None, "origin": "floor",
            "why_considered": "The residual is seated on every board.",
            "why_rejected": "A specific entry (9A991.d) is supported; the residual does not reach.",
            "why_over_alternative": None, "intended_use_rationale": None, "intended_use_family": None,
            "elements": [{
                "element_id": "el:ear99:1", "unit_key": "EAR99", "disposition": "not_met", "basis": "stated",
                "facts_relied_on": [],
                "citation": {"unit_key": "EAR99", "unit_sha256": _hex("7"), "start": 0, "end": 5, "quote": "Items"},
                "missing_fact": None,
            }],
            "fit_quality": None, "challenge": None, "reference_notes": [],
        },
