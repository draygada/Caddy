...
const PART_ECCN: Record<PartId, string> = {
  ...
  icm: 'EAR99 · TDK InvenSense · 2026-06-11', hg5700: '7A002.a.1.a · Honeywell · 2026-05-02', imung: 'not yet classified · SYNTHETIC part', h743: '3A991.a.2 · STMicroelectronics · 2026-03-15', h753: '5A992.c · STMicroelectronics self-classification · 2026-03-15',
};
const PART_VALUE: Record<PartId, number> = { p45b: 288, amprius: 640, lepton: 199, boson: 3450, icm: 12, hg5700: 6200, imung: 4800, h743: 14, h753: 16 };

const FIXED_LINES: Line[] = [
  { id: 'l-gnss', description: 'GNSS receiver module', partClass: 'gnss', slot: null, qtyPerUnit: 1, declaredEccn: '7A994 · u-blox · 2026-04-01', heading: '8526.91', usdValue: 68 },
  { id: 'l-datalink', description: 'Datalink radio', partClass: 'radio', slot: null, qtyPerUnit: 1, declaredEccn: '5A992.c · Microhard · 2026-02-19', heading: '8517.62', usdValue: 420 },
...
export function offersFor(parts: Parts): Offer[] {
  ...
  const bat = parts.battery, th = parts.thermal, imu = parts.imu, fc = parts.fc;
  ...
  if (fc) { add({ lineId: 'l-fc', seller: 'Digi-Key Electronics', sellerCountry: 'US', shipFrom: 'US', declaredOrigin: 'MY', unitPrice: fc === 'h753' ? 16.2 : 14.1, stock: 900, leadDays: 3, moq: 1, authorized: true, declaredEccn: fc === 'h753' ? '5A992.c' : '3A991.a.2', declaredHts: '8542.31', synthetic: false, manufacturer: 'STMicroelectronics' }); add({ lineId: 'l-fc', seller: 'LCSC Electronics', sellerCountry: 'CN', shipFrom: 'CN', declaredOrigin: 'MY', unitPrice: fc === 'h753' ? 12.8 : 10.9, stock: 4200, leadDays: 9, moq: 1, authorized: false, declaredEccn: fc === 'h753' ? '5A992.c' : '3A991.a.2', declaredHts: '8542.31', synthetic: false, manufacturer: 'STMicroelectronics' }); }
  add({ lineId: 'l-gnss', seller: 'u-blox', sellerCountry: 'CH', shipFrom: 'US', declaredOrigin: 'CH', unitPrice: 68, stock: 300, leadDays: 5, moq: 1, authorized: true, declaredEccn: '7A994', declaredHts: '8526.91', synthetic: false, manufacturer: 'u-blox' });
  add({ lineId: 'l-datalink', seller: 'Microhard Systems', sellerCountry: 'CA', shipFrom: 'CA', declaredOrigin: 'CA', unitPrice: 420, stock: 15, leadDays: 10, moq: 1, authorized: true, declaredEccn: '5A992.c', declaredHts: '8517.62', synthetic: false, manufacturer: 'Microhard Systems' });
