...
Three tabs: **Design**, **Classification** (parts of concern, why each trips, the regulation behind an expand) and **Sourcing**. Everything else (Sources, Record, Core / Assembly, Tripwire atlas, Collaboration, Now) is under **More** and in the command box. Keys 1 · 2 · 3 switch tabs.
